...
DEBUFF_BUTTON_DATA = {
    ...
    'health' : {'x':0,'y':0,'width':19,'height':19},
    'ice' : {'x':38,'y':0,'width':19,'height':19},
    'light' : {'x':76,'y':0,'width':19,'height':19},
    
    'lightning' : {'x':0,'y':0,'width':19,'height':19},
    'magic' : {'x':38,'y':0,'width':19,'height':19},
    'neuron' : {'x':76,'y':0,'width':19,'height':19},

    'poison' : {'x':0,'y':0,'width':19,'height':19},
    'shield' : {'x':38,'y':0,'width':19,'height':19},
    'stars' : {'x':76,'y':0,'width':19,'height':19},

    'strengthen' : {'x':0,'y':0,'width':19,'height':19},
    'sunmoon' : {'x':38,'y':0,'width':19,'height':19},
    'swing' : {'x':76,'y':0,'width':19,'height':19},
    
    'swirl' : {'x':0,'y':0,'width':19,'height':19},
    'teleport' : {'x':38,'y':0,'width':19,'height':19},
    'weaken' : {'x':76,'y':0,'width':19,'height':19},
}
