...
class Player(pygame.sprite.Sprite):
    def __init__(self, player_type,projectile_group, enemies):
        ...
        self.maxhealth = PLAYER_DATA[player_type]['health']
        self.health_bar_length = PLAYER_DATA[player_type]['sprite'] * PLAYER_SCALE# sprite means the length of one player frame 
